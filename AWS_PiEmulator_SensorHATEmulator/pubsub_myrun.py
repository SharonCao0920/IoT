...
#python3 aws-iot-device-sdk-python-v2/samples/pubsub_myrun.py --endpoint a287bvhf7sy1kl-ats.iot.us-west-1.amazonaws.com --ca_file root-CA.crt --cert SenseHat.cert.pem --key SenseHat.private.key --client_id senseHat --topic sensehat --count 0